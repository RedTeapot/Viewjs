;(function(ctx, name){
	...
	var getViewObjs = function(){
		return document.querySelectorAll("*[" + viewAttribute.attr$view + "=true]");
	};
	...
	var getViewObjOfId = function(viewId, namespace){
		...
		var domElements = document.querySelectorAll("#" + viewId + "[" + viewAttribute.attr$view + "=true]");
	...
	ctx[name].viewInternalVariable = {
		...
		viewSwitchAnimation: viewSwitchAnimation,

		getViewObjs: getViewObjs,
		getViewObjOfId: getViewObjOfId,
